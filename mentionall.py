...
async def handler(event):
    ...
    await event.reply('**Hey Bot Çalışıyor Merak Etme En iyi Şekilde Burayım** \n Developer @Hzchavo')
...
async def handler(event):
    ...
    await event.reply('**Tagger Botun Bağış Menüsü** \n\nPapara No: Grubumuza Gelsen Yeterli @SoyguncularTR \n\n  👻')
